...
(function() {
    ...
    window.addEventListener("resize", () => {
        ...
        if (window.CURRENT_NOTABLE_ELEMENT) {
            ...
            const is_locked = base.classList.contains("force-tooltip");
            hideNotable();
            if (is_locked) {
                showNotable(base);
                base.classList.add("force-tooltip");
            }
        }
    });
    ...
    function showNotable(e) {
        ...
        wrapper.onpointerleave = function(ev) {
            ...
            if (!e.classList.contains("force-tooltip") && !elemIsInParent(event.relatedTarget, e)) {
                hideNotable();
            }
        };
    };
    ...
    function hideNotable() {
        if (window.CURRENT_NOTABLE_ELEMENT) {
            window.CURRENT_NOTABLE_ELEMENT.NOTABLE_BASE.classList.remove("force-tooltip");
    ...
    onEachLazy(document.getElementsByClassName("notable-traits"), e => {
        e.onclick = function() {
            this.classList.toggle("force-tooltip");
            if (window.CURRENT_NOTABLE_ELEMENT && !this.classList.contains("force-tooltip")) {
                hideNotable();
            } else {
                showNotable(this);
            }
        ...
        e.onpointerleave = function(ev) {
            ...
            if (!this.classList.contains("force-tooltip") &&
